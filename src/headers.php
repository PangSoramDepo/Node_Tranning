...
if (isset($_POST['btnn_login'])){
   ...
   $insert=$pdo->prepare("insert into sompov_db(Id,Name,addr,addrr,village,rigions,code,phone) values(:d,:name,:add,:adde,:vil,:ri,:co,:pho)");
...
<div class = "content-wrapper">
  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>បញ្ចូលឈ្មោះអតិថិជនសំពៅលូន</h1>
          </div>
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="headeruser2s.php">ពិនិត្យបញ្ជីត្រង់នេះ</a></li>
