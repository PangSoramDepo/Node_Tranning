...
<div class="content-wrapper">
  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1>បញ្ជីឈ្មោះអតិថិជនកំរៀង</h1>
          </div>
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="headerk.php">បញ្ចូលឈ្មោះថ្មីត្រង់នេះ</a></li>
...
<section class="content">
 ...
 <?php
    ...
    $select =$pdo->prepare("select * from komreing_db order by Id desc");
     $select->execute();
